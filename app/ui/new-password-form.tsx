    ...
    return (
      <div className="flex-1 rounded-lg bg-gray-50 dark:bg-gray-800 px-6 pb-4 pt-8 shadow-xl border border-gray-100 dark:border-gray-700">
        <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-green-800 dark:text-green-200 mb-2">¡Contraseña actualizada!</h2>
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white font-bold py-2 px-6 rounded-lg transition-colors"
          >
        ...
        <div className="w-full p-6 bg-white dark:bg-gray-900 rounded-xl shadow-inner space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                className="peer block w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 py-3 pl-10 pr-10 text-sm outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all dark:text-white"
                id="password"
                ...
                minLength={6}
              />
              <KeyIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-400 peer-focus:text-green-500 transition-colors" />
              <button
                type="button"

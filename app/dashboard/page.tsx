...
import { fetchRevenue, fetchLatestInvoices } from '@/app/lib/data'; // Importamos la función fetchRevenue de data.ts

export default async function Page() { // componente asiincrono para poder hacer la peticion a la api
    const revenue = await fetchRevenue(); // Llamamos a la función fetchRevenue y guardamos el resultado en la variable revenue

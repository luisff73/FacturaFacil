...
export default async function Page(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className={`${roboto.className} p-6 max-w-4xl mx-auto bg-white text-black min-h-screen shadow-2xl my-10 rounded-2xl border border-gray-100`}>
      ...
      <div className="flex justify-end">
        <div className="w-64">
          ...
          <div className="flex justify-between py-4 mt-2 bg-gray-800 text-white px-4 rounded-lg">
